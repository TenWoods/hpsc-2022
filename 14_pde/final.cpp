...
void build_up_b(Matrix &b, double rho, double dt, Matrix u, Matrix v, double dx, double dy);
void cavity_flow(int nt, Matrix &u, Matrix &v, double dt, double dx, double dy, Matrix &p, double rho, double nu, Matrix b);
...
int main()
{
    ...
    cavity_flow(nt, u, v, dt, dx, dy, p, rho, nu, b);
...
void pressure_poisson(Matrix &p, double dx, double dy, Matrix b)
{
